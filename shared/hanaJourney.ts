...
const journeys: Record<string, JourneyStep[]> = {
  ...
  Cybersecurity: [
    step("Networking foundations", "Learn how devices, networks, and web requests work before studying security.", "learn", 1, "90 min", "None — Hana starts with networking.", ["Explain a device, router, and server", "Trace a simple request", "Name three assets worth protecting"], { label: "Cisco Introduction to Cybersecurity", url: "https://www.netacad.com/courses/introduction-to-cybersecurity" }, "Draw the path from your phone to a website and label the devices.", "Explain where a password could be exposed while travelling across a network.", "A simple network map", "Linux essentials"),
    step("Linux essentials", "Use the command line and permissions found in security work.", "practice", 2, "90 min", "Networking foundations", ["Move through folders", "Read file permissions", "Use safe search commands"], { label: "Linux command line", url: "https://ubuntu.com/tutorials/command-line-for-beginners" }, "Create a practice folder and record five safe commands with notes.", "Hana checks what each command changes before you run it.", "A Linux command reference", "Web and identity safety"),
  ...
  "Mathematics for Computing": [
    step("Algebra for computing", "Use symbols and equations to describe a problem clearly.", "learn", 1, "75 min", "None — Hana starts with the basics.", ["Simplify an expression", "Solve a simple equation", "Explain what a variable means"], { label: "Khan Academy algebra", url: "https://www.khanacademy.org/math/algebra" }, "Turn a small study-time question into an equation and solve it.", "Explain what each symbol means in your own words.", "A study-time equation sheet", "Functions and graphs"),
    step("Functions and graphs", "See how one value changes when another value changes.", "learn", 2, "75 min", "Algebra for computing", ["Read a graph", "Describe input and output", "Compare two simple functions"], { label: "Khan Academy functions", url: "https://www.khanacademy.org/math/algebra/x2f8bb11595b61c86:functions" }, "Plot two simple study plans and explain which changes faster.", "Describe the graph without using a formula first.", "A clear comparison chart", "Logic and discrete thinking"),
    step("Logic and discrete thinking", "Break a problem into exact rules that a computer can follow.", "practice", 3, "90 min", "Functions and graphs", ["Use AND and OR", "Make a truth table", "Spot a contradiction"], { label: "MIT Mathematics for Computer Science", url: "https://courses.csail.mit.edu/6.042/spring18/mcs.pdf" }, "Create rules that decide when a student can start a study mission.", "Test the rules with three different cases.", "A study-mission rule checker", "Probability and statistics"),
    step("Probability and statistics", "Reason about uncertainty without guessing too quickly.", "learn", 4, "90 min", "Logic and discrete thinking", ["Explain probability", "Read an average and spread", "Describe uncertainty"], { label: "Khan Academy statistics", url: "https://www.khanacademy.org/math/statistics-probability" }, "Compare two small datasets and write one careful conclusion.", "Say what your data cannot prove.", "A responsible data note", "Algorithms and complexity"),
    step("Algorithms and complexity", "Use mathematical thinking to make a solution efficient and explainable.", "build", 5, "90 min", "Logic, functions, and probability", ["Write a step-by-step algorithm", "Compare two approaches", "Explain a trade-off", "Test an edge case"], { label: "CS50 algorithms", url: "https://cs50.harvard.edu/x/2025/weeks/3/" }, "Design two ways to find a student’s next lesson and compare the number of checks.", "Explain why your chosen method is easier or faster for a stated case.", "An algorithm comparison project", "Portfolio and further study"),
  ],
  "Data Science": [
