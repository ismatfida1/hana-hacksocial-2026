...
| Automated tests | Passed: 19 test files, 59 tests, including logout invalidation, returning-user hydration, semester-aware planning, and derived career-milestone contract coverage |
