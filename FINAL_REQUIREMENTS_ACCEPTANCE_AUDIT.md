...
| Automated tests | Passed: 19 test files, 61 tests, including logout invalidation, returning-user hydration, semester-aware planning, derived career milestones, project-gate evidence, and persisted explanation-preference contract coverage |
